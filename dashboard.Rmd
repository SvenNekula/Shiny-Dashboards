...
With the function <code>mainPanel(plotOutput("plot"))</code> a place for the plot/visualisation of each distribution depending on the chosen settings/justifications is created next to the sidebar. 
