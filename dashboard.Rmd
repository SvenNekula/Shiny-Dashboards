...
As a first example for an application that can be created with Shiny we decided to construct a distribution plotter. It is an application which can draw the density functions of different distributions. The chosen distributions for the application are beta distribution, normal distribution and t distribution. 
...
After installing and loading the shiny package, as always in the Shiny app at first the user interface, the UI, has to be defined. This includes the whole layout and in particular the interactive elements which in this case is a dropdown menu and sliders.
...
Now the UI and also the server logic is defined which means that the app can run and be seen down below.
