...
The sliders are created with the function <code>conditionalPanel()</code>. Depending on which distribution was chosen in the dropdown menu above, the parameters and their value range vary.
