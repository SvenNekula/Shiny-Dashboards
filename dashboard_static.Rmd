...
&p(x|\alpha, \beta) = \frac{\Gamma(\alpha + \beta)}{\Gamma(\alpha)\Gamma(\beta)}x^{\alpha -1}(1-x)^{\beta -1} \: for \: 0 < x < 1 \\
&with \: \alpha,\beta > 0
\end{align*}
...
&p(x|\mu, \sigma^2) = \frac{1}{\sqrt{2\pi\sigma^2}}exp\{-\frac{1}{2\sigma^2}(x-\mu)^2\} \: for \: x \in R \\
&with \: \mu \in R \: and \: \sigma^2 > 0
\end{align*}
...
The t-distribution is depending on the degrees of freedom nu.
...
```{r regression, echo=FALSE, fig.cap="A caption", out.width = '100%'}
